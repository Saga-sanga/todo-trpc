  ...
  return (
    <>
      ...
      {editing ? (
        <input
          type="text"
          className="text-sm w-full border px-2 py-1 rounded-md border-primary focus:outline-primary focus-visible:outline-primary focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
          value={content}
